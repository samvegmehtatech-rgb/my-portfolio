...
const EDUCATION = [
  {
    ...
    description: 'Completed Higher Secondary Education with Commerce stream. Built a strong foundation in mathematics and computers that sparked my passion for technology and software development.',
  ...
  },
  {
    ...
    highlight: 'B.Sc.(IT) — CGPA 9.35 | 🏅 Gold Medal',
    icon: '🎓',
  },
  {
    year: '2024 – Present',
    ...
    highlight: "M.Sc.(IT) — CGPA 9.25 (Ongoing)",
    icon: '🎓',
  },
]
